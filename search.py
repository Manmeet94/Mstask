...
def breadthFirstSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    def breadthFirstSearch(problem):"""Search the shallowest nodes in the search tree first."""
...
def uniformCostSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    def uniformCostSearch(problem):"""Search the node of least total cost first."""
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    "*** YOUR CODE HERE ***"
    def aStarSearch(problem, heuristic=nullHeuristic):"""Search the node that has the lowest combined cost and heuristic first."""
